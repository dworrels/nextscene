...
import { deleteWatchlistAction } from "@/lib/watchlist-actions";
...
export function WatchlistDeleteButton() {
  return <form
    action={deleteWatchlistAction}
    onSubmit={(event) => {
      if (!window.confirm("Delete your entire imported watchlist? This can't be undone.")) event.preventDefault();
    }}
  >
    <SubmitButton />
  </form>;
