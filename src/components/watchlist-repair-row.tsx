...
import { repairWatchlistRowAction, type RepairState } from "@/lib/watchlist-actions";
...
export function WatchlistRepairRow({ imdbId, mediaType, title }: { imdbId: string; mediaType: MediaType; title: string }) {
  const [state, formAction] = useActionState(repairWatchlistRowAction, initialState);
